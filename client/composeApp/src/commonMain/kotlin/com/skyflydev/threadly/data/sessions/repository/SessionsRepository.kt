...
interface SessionsRepository {
    ...
    suspend fun createSession(theme: String, maxRounds: Int): AppResult<String, AppError>
    suspend fun joinSession(sessionId: String): AppResult<Player, AppError>
    suspend fun leaveSession(sessionId: String): AppResult<Unit, AppError>
    suspend fun setReady(value: Boolean, sessionId: String): AppResult<Player, AppError>
}